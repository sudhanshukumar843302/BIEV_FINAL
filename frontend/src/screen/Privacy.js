      ...
      <div className="card-list">
        <div className="option-card">
          ...
          <div className="card-btn">
            <button onClick={()=>{setShowPhotoPrivacy(true)}}>Click Me</button>
          </div>
        </div>
        <div className="option-card">
          <div className="detail">
          ...
          <div className="card-btn">
            <button onClick={()=>{setShowFollowerPrivacy(true)}}>Click Me</button>
          </div>
        </div>
        <div className="option-card">
          <div className="detail">
          ...
          <div className="card-btn">
            <button onClick={()=>{setShowFollowingPrivacy(true)}}>Click Me</button>
          </div>
        </div>
        <div className="option-card">
          <div className="detail">
          ...
          <div className="card-btn">
            <button onClick={()=>{setShowDownload(true)}}>Click Me</button>
          </div>
        </div>
        <div className="option-card">
          ...
          <div className="card-btn">
            <button onClick={()=>{setShowAppsList(true)}}>Click Me</button>
          </div>
        </div>
      </div>
